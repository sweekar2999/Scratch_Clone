        ...
        <div>{parts.map((part, partIndex) => (
            <React.Fragment key={partIndex}>
                ...
                {partIndex < parts.length - 1 && inputCallbacks[partIndex] && (
                    <input
                        type="number"
                        className="w-16 mx-1 px-2 py-1 text-black rounded border border-blue-300 transition duration-200 hover:bg-blue-100 hover:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-300" // Added hover effect
                        value={
